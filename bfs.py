...
class Node(object):
    ...
    def gen_rules(self):  # 从一个状态产生所有applicable的规则
        apprules = []
        ...
        if c1 == c2:
            ...
            if 31 in apprules and 32 in apprules:
                apprules.remove(32)
        if c1 + c2 == 8:
            if 12 in apprules and 21 in apprules:
                apprules.remove(21)
        ...
        if p4 < 4 and p4 != p1 and p4 != p3 and p4 != p2:
            ...
            if c3 <= 4-p4 and c3 > 0:
                apprules.append(403)
        if self.parent_rule is not None and self.parent_rule in apprules:
            apprules.remove(self.parent_rule)
        return apprules
...
if __name__ == "__main__":
    rule_map = {12: '8两杯1倒入8两杯2', 13: '8两杯1倒入3两杯', 21: '8两杯2倒入8两杯1', 23: '8两杯2倒入3两杯', 
            31: '3两杯倒入8两杯1', 32: '3两杯倒入8两杯2', 
